...
const AboutAbout = () => {
  return (
    <div className="w-full h-full pb-5 lg:pb-36 relative z-20">
      <div className="px-4 lg:px-[8.2rem] text-white flex flex-col items-center lg:flex-row justify-between gap-9 py-36">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-lg lg:text-2xl mb-4 border-2 w-full border-white bg-gradient-to-r from-blue-600/30 via-white/[0.03] to-blue-400/30 backdrop-blur shadow-[0px_6px_6px_0px_rgba(0,0,0,0.25)] py-6 px-8">
